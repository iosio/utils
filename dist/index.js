(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './util/color', './util/comparisons', './util/crud_operations', './util/empty_checks', './util/filters', './util/has_checks', './util/misc', './util/number_generation', './util/string_manipulation', './util/time', './util/type_checks', './util/isShape', './dom/loaders', './dom/noScroll'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./util/color'), require('./util/comparisons'), require('./util/crud_operations'), require('./util/empty_checks'), require('./util/filters'), require('./util/has_checks'), require('./util/misc'), require('./util/number_generation'), require('./util/string_manipulation'), require('./util/time'), require('./util/type_checks'), require('./util/isShape'), require('./dom/loaders'), require('./dom/noScroll'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.color, global.comparisons, global.crud_operations, global.empty_checks, global.filters, global.has_checks, global.misc, global.number_generation, global.string_manipulation, global.time, global.type_checks, global.isShape, global.loaders, global.noScroll);
        global.index = mod.exports;
    }
})(this, function (exports, _color, _comparisons, _crud_operations, _empty_checks, _filters, _has_checks, _misc, _number_generation, _string_manipulation, _time, _type_checks, _isShape, _loaders, _noScroll) {
    'use strict';
    ...
    Object.defineProperty(exports, 'sortObjArrByDateTime', {
        enumerable: true,
        get: function () {
            return _time.sortObjArrByDateTime;
        }
    });
    ...
    Object.defineProperty(exports, 'isBoolean', {
        enumerable: true,
        get: function () {
            return _type_checks.isBoolean;
        }
    });
    Object.defineProperty(exports, 'isShape', {
        enumerable: true,
        get: function () {
