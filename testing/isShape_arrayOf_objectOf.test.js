import {isShape, type_map, objectOf, arrayOf} from "../src/isShape";
...
describe('isShape', () => {
    ...
    describe('isShape', () => {
        it('should validate that object is correct shape', () => {
...
//------------------- test schemas ------------
            ...
            expect(isShape({a: 'asdf'}, {a: {type: 'string'}}).ok).toEqual(true)
    ...
    describe('objectOf', () => {
        ...
        it('should validate that an object has properties of a particular type and or shape', () => {
            expect(objectOf(
                {
                    a: {c: 123},
                    b: {c: 123}
        ...
        it('should validate that an object does not have properties of a particular type and or shape', () => {
            expect(objectOf(
                {
                    a: {c: 123},
                    b: {c: 123}
