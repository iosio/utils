(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './color', './comparisons', './crud_operations', './empty_checks', './filters', './has_checks', './misc', './number_generation', './string_manipulation', './time', './type_checks'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./color'), require('./comparisons'), require('./crud_operations'), require('./empty_checks'), require('./filters'), require('./has_checks'), require('./misc'), require('./number_generation'), require('./string_manipulation'), require('./time'), require('./type_checks'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.color, global.comparisons, global.crud_operations, global.empty_checks, global.filters, global.has_checks, global.misc, global.number_generation, global.string_manipulation, global.time, global.type_checks);
        global.index = mod.exports;
    }
})(this, function (exports, _color, _comparisons, _crud_operations, _empty_checks, _filters, _has_checks, _misc, _number_generation, _string_manipulation, _time, _type_checks) {
    'use strict';
